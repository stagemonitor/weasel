...
const defaultVars: {
  ...
  // Configure whether Content-Security Policy violations should be
  // collected.
  //
  // Set via:
  // eum('collectCspViolations', false)
  ...
  // Weasel will attempt to record resource timings. You can use this
  // setting to disable the transmission of the data.
  //
  // Set via:
  // eum('disableResourceTimingTransmission', true)
  disableResourceTimingTransmission: boolean
